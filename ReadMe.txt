...
(3) Building method for sample code
  1. The sample code is built to be operated on Windows 10 or 11.
     It can be compiled and linked with Visual Studio 2010 or later versions.
  2. The exe file is generated under Sample/bin after compilation.
 
(4) Usage of sample code
  STBLib DLL file is needed on the same directory with the exe file for execution.
  （In advance, libSTB.dll is stored in Sample/bin directory.)
  1. When you run the the exe file, the form screen will appear.
  2. Select the COM port number that the B5T-007001 is connected, from the form screen. 
  3-1. Press the "Execute" button to start "Detection Process".
  3-2. Press the "Register" button to start "Registration Process".
...
----
OMRON Corporation 
Copyright 2018-2025 OMRON Corporation, All Rights Reserved.
